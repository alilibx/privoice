...
| Web | React + Vite (SPA) | online tier only | **1 (in progress)** | 🔨 O1 auth+CRUD · C1 docs/RAG · C2 agentic chat · C3 shadcn redesign · C4 retrieval v2 — all ✅ merged · C5 chat-UX+de-dup+list-docs ✅ code-complete on branch (C3+C4+C5 browser smoke pending) |
