    ...
    <main className="mx-auto max-w-2xl p-6">
      ...
      <form onSubmit={add} className="mt-6 flex gap-2">
        <input aria-label="New meeting title" value={title}
          ...
          className="flex-1 rounded-lg border border-outline bg-surface px-3 py-2 text-on-surface placeholder:text-on-surface-variant focus:outline-none focus:ring-2 focus:ring-primary" />
        <button type="submit"
